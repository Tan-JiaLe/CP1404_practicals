...
def run_tests():
    ...
    test_car.add_fuel(66)
    assert test_car.fuel == 66, "Car does not set fuel correctly"
    test_car.drive(10)
    assert test_car.fuel == 56, "Car does not set fuel correctly"
...
def change_phrase_to_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> change_phrase_to_sentence('coding is fun')
    'Coding is fun
    """
