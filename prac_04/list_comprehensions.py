...
numbers = [int(str) for str in almost_numbers]
print(numbers)

# TODO: list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
greater9_numbers = [number for number in numbers if number>9]
print(greater9_numbers)
...
last_name = ", ".join([name.split()[-1] for name in full_name if len(name) > 11])
print(last_name)